...
public class NameGen {
    ...
    public static String gen() {
        ...
        for(int i = 0; i < middle; i++)
            name = (new StringBuilder()).append(name).append(name2[rand.nextInt(name2.length)]).toString();
        return (new StringBuilder()).append(name).append(name3[rand.nextInt(name3.length)]).toString();
    }
