...
import net.minecraft.src.EntityDartEnchanted;
...
public class EntityDartEnchantedMp extends EntityDartEnchanted implements ISpawnable {

	public EntityDartEnchantedMp(World world) {
		super(world);
	}
