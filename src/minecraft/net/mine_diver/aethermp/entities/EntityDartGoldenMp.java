...
import net.minecraft.src.EntityDartGolden;
...
public class EntityDartGoldenMp extends EntityDartGolden implements ISpawnable {

	public EntityDartGoldenMp(World world) {
		super(world);
	}
